...
<footer id="footer" className="border-0 mt-0">
    <div className="container py-3">
        <div className="row text-center text-md-start my-5">
            <div className="col-md-4 col-lg-4 text-center text-md-start mb-5 mb-lg-0 column1 my-0">
                <a href="\"
            ...
            <div className="col-md-4 col-lg-2 mb-5 mb-lg-0 columns2">
                <h5 style={{textAlign:'center'}} className="text-transform-none font-weight-bold text-color-light text-4-5 mb-4">About Us</h5>
               <ul >
               <li  style={{listStyle:'none',marginTop:'5px',marginLeft:'15px'}}> <Link to='/about'style={{textDecoration:'none'}}>About</Link> </li>
               <li style={{listStyle:'none',marginTop:'15px',marginLeft:'15px'}}> <Link to='/services' style={{textDecoration:'none'}}>Services</Link></li> 
               <li style={{listStyle:'none',marginTop:'15px',marginLeft:'15px'}}><Link to='/products'style={{textDecoration:'none'}}>Products</Link></li> 
               <li style={{listStyle:'none',marginTop:'15px',marginLeft:'15px'}}> <Link to='/Technology' style={{textDecoration:'none'}}>Technology</Link></li>
               <li style={{listStyle:'none',marginTop:'15px',marginLeft:'15px'}}> <Link to='/portfolio' style={{textDecoration:'none'}}>Portfolio</Link></li>
               <li style={{listStyle:'none',marginTop:'15px',marginLeft:'15px'}}> <Link to='/contactus'style={{textDecoration:'none'}}>Contact</Link></li>
               </ul>
            ...
            <div className="col-md-6 col-lg-5 mb-5 mb-md-0">
                ...
                <div
                    ...
                    <div className="feature-box-info line-height-1 ps-2">
                        ...
                        <p className='mb-0'>VKR complex, Behind bus stand, Surandai 627859.</p>
                        <h5 className='font-weight-bold text-4 line-height-4 font-weight-light mb-0 light-color'>Branches</h5>
                        <p className='mb-2'>Chennai,Tenkasi-Tamilnadu</p>
