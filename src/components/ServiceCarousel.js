...
import service8ML from '../images/service8-Ml.png';
    ...
    <Slider {...settings}>
      ...
      <Link to="/services"
                ...
                <div
                    className="custom-thumb-info-style-1 thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-lighten">
                    <div className="thumb-info-wrapper">
                        <img src={service8ML} className="img-fluid" alt="" />
                    </div>
                    <h3 className="text-transform-none font-weight-bold text-5 mt-2 mb-0">Machine Learning
                    </h3>
                </div>
            </Link>
      </div>
