                    ...
                    <div
                      ...
                      <nav className="collapse" id="collapseTarget">
                        <ul className="nav nav-pills" id="mainNav">
                          <li><Link onClick={()=>handlechenge("/","Home")} to="/" className="nav-link">Home</Link></li>
                          <li><Link onClick={()=>handlechenge("/about","About")} to="/about" className="nav-link">About</Link></li>
                          <li><Link onClick={()=>handlechenge("/services","Services")} to="/services" className="nav-link">Services</Link></li>
                          <li className="dropdown">
                            <Link to="/products" className="nav-link dropdown-toggle" onClick={() => setMenuVisible(menuVisible ? false : true)}title="Products">Products
                            </Link>
                            {menuVisible ? (
                              <ul className="">
                          ...
                          <li><Link onClick={()=>handlechenge("/technology","Technology")} to="/technology" className="nav-link">Technology</Link></li>
                          <li><Link onClick={()=>handlechenge("/portfolio","Portfolio")} to="/portfolio" className='nav-link'>Portfolio</Link></li>
                          <li><Link onClick={()=>handlechenge("/contactus","Contact")} to="/contactus" className="nav-link">Contact</Link></li>
                        </ul>
                      </nav>
