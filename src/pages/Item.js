           ...
           return (
            <div className="col-md-3 mb-4 col-lg-1-5 isotope-item brands" key={id}>
                                <div className="portfolio-item">
                                    <Link to={url} target="_blank" style={{textDecoration:'none',textAlign:'center',fontSize:"15px",fontWeight:"700"}}>
                                        <span className="thumb-info thumb-info-lighten border-radius-0">
                                            <span className="thumb-info-wrapper border-radius-10">
                                                <img src={image} className="img-fluid border-radius-0" alt="" /><br/><br/>

                                                <span style={{color:"black",textDecoration:"none",marginBottom:"-10px"}}>{title}
